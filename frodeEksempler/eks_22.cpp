...
int main()  {
    ...
    map <int, string> mengde1;            //  Lager mengde med nøkkelen 'int',
                                          ...
                                          //  Initierer med en del data:
    mengde1.insert(pair <int, string> (5, "Elvira"));   //  Slik:
    mengde1.insert(pair <int, string> (3, "Christian"));
    mengde1.insert(pair <int, string> (7, "Gogutten"));
    mengde1.insert(make_pair(2, "Bendik"));             //  eller slik:
    mengde1.insert(make_pair(1, "Anette"));
    mengde1.insert(make_pair(4, "Daniel"));
    mengde1[6]  = "Frida";                              //  eller (bare) slik:
    mengde1[10] = "Jeanette";
    mengde1[8]  = "Haavard";
    mengde1[9]  = "Ingrid";
